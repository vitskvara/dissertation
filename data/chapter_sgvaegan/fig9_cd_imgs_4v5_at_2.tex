\begin{tikzpicture}[scale=1.0] 
  ...
  \draw (3.6625,0) -- (3.6625,0.6) -- (2.9, 0.6) node[anchor=east] {SGVAE$_{\alpha}$}; 
  \draw (4.4125,0) -- (4.4125,1.0) -- (2.9, 1.0) node[anchor=east] {CGN}; 
  \draw (4.75,0) -- (4.75,1.4) -- (2.9, 1.4) node[anchor=east] {SGVAEGAN}; 
  \draw (5.4,0) -- (5.4,1.8) -- (2.9, 1.8) node[anchor=east] {fmGAN}; 
  \draw (5.6375,0) -- (5.6375,1.8) -- (9.1, 1.8) node[anchor=west] {SGVAE}; 
  \draw (6.15,0) -- (6.15,1.4) -- (9.1, 1.4) node[anchor=west] {VAEGAN}; 
  \draw (6.475,0) -- (6.475,1.0) -- (9.1, 1.0) node[anchor=west] {fAnoGAN}; 
  \draw (7.0875,0) -- (7.0875,0.6) -- (9.1, 0.6) node[anchor=west] {VAE}; 
