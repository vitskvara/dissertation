\begin{tikzpicture}
  ...
  % encoder tag
  \node[const, right = 1.4cm of x, yshift = 1.5cm] (E) {$e_{\vc{\phi}}(\vc{x})$};
  \node[const, right = 3.4cm of x, yshift = 1.5cm] (ED) {$q_{\vc{\phi}}(\vc{z}|\vc{x})$};
  % code
  ...
  % decoder tag
  \node[const, right = 1.6cm of z, yshift = 1.5cm] (D) {$g_{\vc{\theta}}(\vc{z})$};   
  \node[const, right = 3.5cm of z, yshift = 1.5cm] (DD) {$p_{\vc{\theta}}(\vc{x}|\vc{z})$};   
