...
Different types of anomalies which require different approaches have been identified in literature~\cite{chandola2009anomaly,ruff2020unifying}. Examples for each type are presented in Fig.~\ref{fig:anomaly_examples}.
\begin{itemize}
